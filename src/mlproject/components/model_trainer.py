    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            with mlflow.start_run():
                ...
                logging.info(f"RMSE: {rmse}, MAE: {mae}, R²: {r2}")
                print(f"R² Score: {r2:.16f}")
                ...
                # Added input_example for better MLflow model signature
            ...
            return r2  # Return R² Score

        except Exception as e:
            logging.error(f"An error occurred: {str(e)}")
            print(f"Error: {str(e)}")  # Added for better visibility
